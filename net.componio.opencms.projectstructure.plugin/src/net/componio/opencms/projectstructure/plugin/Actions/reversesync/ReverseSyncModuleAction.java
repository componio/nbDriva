...
public final class ReverseSyncModuleAction extends AbstractAction implements LookupListener, ContextAwareAction {
    ...
    ReverseSyncModuleAction() {
        this(Utilities.actionsGlobalContext());
    }

    ReverseSyncModuleAction(Lookup context) {
        ...
        putValue(NAME, Bundle.CTL_ReverseSyncModuleAction());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ActionUtils.runTarget(buildScript, new String[]{"build_cms_reverse_sync"}, null);
    ...
    public Action createContextAwareInstance(Lookup lkp) {
        return new ReverseSyncModuleAction(lkp);
    }
}
