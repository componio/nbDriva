...
@ActionID(
        category = "Build",
        id = "net.componio.opencms.projectstructure.plugin.Actions.SyncModuleAction")
@ActionRegistration(
        displayName = "#CTL_SyncModuleAction")
@ActionReferences({
    
    @ActionReference(path = "Projects/Actions",position = 20, separatorAfter = 25)
})
...
public final class SyncModuleAction extends AbstractAction implements LookupListener, ContextAwareAction {
    ...
    SyncModuleAction(Lookup context) {
        ...
        putValue(NAME, Bundle.CTL_SyncModuleAction());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ActionUtils.runTarget(buildScript, new String[]{"build_sync_folder_standalone"}, null);
    ...
    public Action createContextAwareInstance(Lookup lkp) {
        return new SyncModuleAction(lkp);
    }
}
