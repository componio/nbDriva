...
@ActionID(
        category = "Build",
        id = "net.componio.opencms.projectstructure.plugin.Actions.CreateModuleAction")
@ActionRegistration(
        displayName = "#CTL_CreateModuleAction")
@ActionReferences({
    
    @ActionReference(path = "Projects/Actions", position = 5, separatorBefore = 0)
})
@Messages("CTL_CreateModuleAction=Create Module")
public final class CreateModuleAction extends AbstractAction implements LookupListener, ContextAwareAction {
    ...
    CreateModuleAction(Lookup context) {
        ...
        putValue(NAME, Bundle.CTL_CreateModuleAction());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ActionUtils.runTarget(buildScript, new String[]{"build_new_module"}, null);
    ...
    public Action createContextAwareInstance(Lookup lkp) {
        return new CreateModuleAction(lkp);
    }
}
